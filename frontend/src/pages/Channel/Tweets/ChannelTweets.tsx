...
const ChannelTweets: React.FC = () => {
	...
	return (
		<div className="px-4 pt-4 mx-auto w-full max-w-6xl flex justify-center flex-col gap-4">
			...
			{/* Add Tweets */}
			<div className={twMerge("text-white flex flex-col w-full items-end px-4 py-2 bg-[#555] rounded-xl border-[1px] pt-1",
				...
				<div className="flex justify-between w-full">
					...
					<div className="flex gap-2">
						<button className="font-semibold hover:bg-[#888] px-3 py-1 rounded-full duration-300">
							Cancel
						</button>
						<button
							className={twMerge(
								"px-3 py-1 rounded-full bg-primary opacity-70",
								comment != "" && "opacity-100"
							)}>
							Comment
						</button>
