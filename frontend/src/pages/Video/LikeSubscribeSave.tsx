    ...
    return (
        <div className="flex items-center gap-2 flex-wrap justify-end">
            <button
                ...
                className={twMerge(
                    "bg-primary h-fit text-white font-semibold px-4 py-1 sm:px-3 sm:text-sm rounded-md hover:bg-white hover:text-primary duration-300",
            ...
            <div className="border-2 border-white rounded-lg w-fit flex items-center px-2 my-2">
                <button
                    ...
                    className="flex items-center gap-1 text-white border-r-2 pr-2 py-0.5">
                    {isliked ? <BiSolidLike /> : <BiLike />}
                    <span className="sm:text-sm">{like}</span>
                </button>
                <button
                    onClick={() => setIsDisliked(!isDisliked)}
                    className="flex items-center gap-1 text-white pl-2 py-0.5">
                    {isDisliked ? (
                        <BiSolidDislike />
                    ) : (
                        <BiDislike />
