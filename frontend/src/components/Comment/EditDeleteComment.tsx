...
const EditDeleteComment: React.FC<EditDeleteCommentProps> = ({ commentId, editDeleteOption, setEditDeleteOption }) => {
	...
	return (
		<div className="relative right-0 top-0 cursor-pointer text-primary-text">
